...
#NEI$year <- year(strptime(NEI$year, "%Y"))
...
#Plotting
png(filename = 'plot1.png',bg= 'transparent', width=500, height=480)

plot(ToTal_Emissions_grouped_year,xlab = "Years",
     ylab = expression('PM'[2.5]*' Emissions in kilotons'),type='b',
     col= 'black',ylim=c(min(ToTal_Emissions_grouped_year$Emissions)-1000,
